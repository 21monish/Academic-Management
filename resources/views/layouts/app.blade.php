@php
    ...
    if ($routeName) {
        ...
        $breadcrumbMap = [
            ...
            'reports.certificates' => ['section' => 'Reports', 'label' => 'Certificates', 'index' => 'reports.certificates'],
            'reports.activity' => ['section' => 'Reports', 'label' => 'Activity Logs', 'index' => 'reports.activity'],
            'approvals' => ['section' => 'System', 'label' => 'Approval Requests', 'index' => 'approvals.index'],
            'system.plans' => ['section' => 'System', 'label' => 'Manage Plans', 'index' => 'system.plans.index'],
